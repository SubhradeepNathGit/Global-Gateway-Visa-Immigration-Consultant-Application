    ...
    >
      ...
      >
        <div className="flex flex-col justify-center flex-1 px-8 sm:px-12 md:px-16 py-12">
          ...
          <div className="mb-8">
            <span className="text-xs tracking-[0.25em] uppercase text-white/40 font-medium block mb-2">Step 1 of 2</span>
          ...
          <button
            ...
            className={`w-full py-3 mt-6 rounded-md font-semibold text-white bg-white/10 border border-white/20 hover:bg-black transition duration-300 ${isSubmitting ? 'cursor-not-allowed opacity-70' : 'cursor-pointer'}`}
          >
